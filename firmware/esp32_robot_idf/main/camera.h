...
// Bigger frames raise WiFi/BLE coex pressure on classic ESP32's shared
// radio. Add a runtime resolution toggle if higher-res becomes a real
// need — OV3660 supports set_framesize() at runtime.
...
// Refcounted acquire/release. Consumers (http_stream MJPEG handler,
// snapshot task) call acquire when they need frames and
