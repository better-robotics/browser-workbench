...
// Saturate the LLM-path motor cap. Firmware caps move_motor pulses to
// ±70 (LLM_MAX_SPEED in pi_robot.py / motors.c); anything we send above
// that is clipped firmware-side. The joypad path bypasses this cap (it
// uses 2-byte direct-apply payloads), which is why dragging the stick
// feels much faster than scripted demos. 70 is as fast as a demo can
// move without changing the firmware floor.
const SPEED = 70;
